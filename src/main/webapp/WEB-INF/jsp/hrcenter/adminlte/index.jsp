...
<!--       <form action="#" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a> <i class="fa fa-dashboard"></i>HR中心</a></li>
...
<ul>
<li><small>发布职位</small></li>
<li><small>对已发布职位进行管理</small></li>
<li><small>注册企业，完成检测获得认证</small></li>
<li><small>简历管理具有查看和删除功能</small></li>
<li><small>HR可以查看基本信息,以及修改部分内容</small></li>
</ul>
</div></div>
</div>
      <!--------------------------
