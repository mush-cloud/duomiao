          ...
          <li class="dropdown user user-menu">
           ...
           <%-- <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="${pageContext.request.contextPath}${SESSION_admin_INFO.imgUrl}" class="img-circle" alt="User Image">
                <p>
...
<!--       <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin/adminlte/enManageAdmin"><i class="fa fa-link">></i> <span>管理员信息管理</span></a></li>
...
<script src="${pageContext.request.contextPath}/dmjs/common/bstable/bootstrap.min.js"></script>
...
<script src="${pageContext.request.contextPath}/dmjs/admincenter/adminlte/manageadmin.js"></script>
</body>
</html>