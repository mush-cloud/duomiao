...
<%-- <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.12.1/bootstrap-table.min.css">--%>
 ...
 <link rel="stylesheet"
        href="${pageContext.request.contextPath}/dmcss/admincenter/adminlte/managecategory.css">
</head>
...
<!--       <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin/adminlte/enManageCategory"><i class="fa fa-link">></i> <span>职位类别管理</span></a></li>
    <!--     <li class="treeview">
...
<div class="main-body" style="margin-top: -10px">
  <!--ztree-->
<div id="tool"><button id="addBaseCat" class="btn btn-default"><i class="glyphicon glyphicon-plus  icon-plus"></i></button></div>
  <table id="cateList"></table>
<div class="layer_check" hidden><table id="childList"></table></div>
  <div class="layer_addbase" hidden><form id="baseCateAdd">
    <div><font color="#a52a2a" size="3px">*</font>类别名称：<input name="typeName" id="typeName" class="addName"/></div>
    <div><font color="#a52a2a" size="3px">*</font>去向路径：<input name="url" id="url" class="addUrl"/></div>
  <%--  <button class="" id="subBaseCate">提交</button>--%>
  </form></div>

  <div class="layer_addchild" hidden><form id="childCateAdd">
    <div><font color="#a52a2a" size="3px">*</font>类别名称：<input name="typeName" id="typeNameChild" class="addChildName"/></div>
    <div><font color="#a52a2a" size="3px">*</font>去向路径：<input name="url" id="urlChild" class="addChildUrl"/></div>
    <input name="fatherId" id="fatherId" hidden/>
    <%--  <button class="" id="subBaseCate">提交</button>--%>
  </form></div>

  <div class="layer_editBase" hidden><form id="baseCateEdit">
    ...
    <input name="id" id="baseId" hidden/>
    <%--  <button class="" id="subBaseCate">提交</button>--%>
  </form></div>
...
<script src="${pageContext.request.contextPath}/dmjs/admincenter/adminlte/managecategory.js"></script>
