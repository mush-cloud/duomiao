...
<!--       <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/admin/adminlte/enManageIntern"><i class="fa fa-link">></i> <span>实习生用户管理</span></a></li>
...
<script src="${pageContext.request.contextPath}/dmjs/admincenter/adminlte/manageintern.js"></script>
