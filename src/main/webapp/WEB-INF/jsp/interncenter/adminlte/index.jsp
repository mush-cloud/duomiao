...
<!--       <form action="#" method="get" class="sidebar-form">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a> <i class="fa fa-dashboard"></i>个人中心</a></li>
...
<div class="b2"><center><div style="font-size:20px" >服务概述</div></center><div>
<ul>
<li><small>个人课程的梳理</small></li>
<li><small>猫侍社区个人信息的管理</small></li>
<li><small>我的收藏针对职位或公司的收藏</small></li>
<li><small>简历管理具有简历的制作与修改功能</small></li>
<li><small>实习生可以查看基本信息,以及修改部分内容</small></li>
</ul>
</div></div>
</div>
      <!--------------------------
